 ...
 * @author Manda
 */
public class VuePayementCommande extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            detailCommande.payer();
            // redirection vers la page de payement
            List<DetailCommande> detailsCommande = commande.getListeDetailCommande();
            request.setAttribute("detailsCommande", detailsCommande);
            request.setAttribute("commande", commande);
            RequestDispatcher dispat = request.getRequestDispatcher("payementCommande.jsp");
