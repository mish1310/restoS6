 ...
 * @author User
 */
public class AjoutDetailCommande extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(listeDetailCommande == null){
                listeDetailCommande = new ArrayList<DetailCommande>() ;
            }
            ...
            for (int i = 0; i < quantite; i++) {
                listeDetailCommande.add(dc);
            }
            
            session.setAttribute("listeDetailCommande", listeDetailCommande);
